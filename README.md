# quarkus-reproducer-post-construct-issue Project
...
You can then execute your native executable with: `./build/quarkus-reproducer-post-construct-issue-1.0-SNAPSHOT-runner`
